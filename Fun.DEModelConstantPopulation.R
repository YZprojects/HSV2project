  ...
  HSV_Trans <- function(t, state, parameters) {
     with(as.list(c(state)),{
       ...
       # dIs <- (1-parameters["p"])*parameters["beta_c"]*S*(Ia+Is) -parameters["mu"]*Is
        ...
        #testing model
        dS <- parameters["mu"]*N - parameters["sigma"]*parameters["beta_c"]*S*Is - parameters["beta_c"]*S*(Ianeg+parameters["Stau"]*Iapos)-parameters["mu"]*S
        dIaneg <- parameters["p"]*(parameters["sigma"]*parameters["beta_c"]*S*Is +parameters["beta_c"]*S*(Ianeg+parameters["Stau"]*Iapos)) - parameters["taua"]*Ianeg - parameters["mu"]*Ianeg
        dIapos <- parameters["taua"]*Ianeg - parameters["mu"]*Iapos
        dIs <- (1-parameters["p"])*(parameters["sigma"]*parameters["beta_c"]*S*Is + parameters["beta_c"]*S*(Ianeg+parameters["Stau"]*Iapos)) - parameters["mu"]*Is
